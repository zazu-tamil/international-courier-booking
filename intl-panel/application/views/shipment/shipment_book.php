                    ...
                    <div class="panel-body text-center" style="padding: 20px;">
                      ...
                      <div class="form-group text-left" style="margin-top: 10px;">
                        ...
                        <div class="input-group">
                          ...
                          <input type="number" step="0.01" min="0.01" name="estimated_charges_val" id="estimated_charges_val" class="form-control input-lg" style="font-weight: bold; color: #0073b7;" placeholder="0.00" required readonly>
                        </div>
