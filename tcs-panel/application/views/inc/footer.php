...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y');?> COURIER SYNDICATE. All Rights Reserved. 
    <span style="display: none;">Powered By <a href="tel:+917092889602">CR INFO TECH</a>.</span>
    </strong> 
</footer>
