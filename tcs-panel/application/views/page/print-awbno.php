        ...
        <div class="col-xs-12" id="mtc">
            <table class="table table-condensed table-bordered " id="content-table"> 
                ...
                <tr>
                    ...
                    <td colspan="3" rowspan="1" class="text-center"><?php echo $label['service_name'];?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3"> <?php echo $label['commodity_type'];?><br /><?php echo $label['description'];?></td>
                </tr>
                <tr> 
                ...
                <tr>
                    ...
                    <td colspan="2" class="text-center">NO.OF PCS</td> 
                ...
                <tr>
                    ...
                    <td>Currency : INR</td>
                    <td colspan="2" class="text-center"><?php echo $label['no_of_pieces'];?></td>
                    <td class="text-center"><?php echo $label['chargable_weight'];?> Kgs</td>
                </tr>
                <tr>
                    <td colspan="4">
