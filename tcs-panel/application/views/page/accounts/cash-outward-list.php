<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Cash Outward List</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Petty Cash</a></li> 
    <li class="active">Cash Outward List</li>
  </ol>
</section>
<!-- Main content -->
          ...
          <tbody>
               <?php  foreach($record_list as $j=> $ls){  ?> 
                <tr> 
                    ...
                    <td><?php echo date('d-m-Y', strtotime($ls['outward_date']))?></td>   
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        ...
                                        <input class="form-control datepicker" type="text" name="outward_date" id="outward_date" value="">
                                    </div>                                              
                                 </div>
                                 <div class="form-group col-md-6">
