<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>
     Recycle Booking List
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Recycle Bin</a></li> 
    <li class="active">Recycle Booking List</li>
  </ol>
</section>
<!-- Main content -->
<section class="content"> 
  <!-- Default box -->
    <div class="box box-info"> 
        ...
        <div class="box-body">
             <form method="post" action="<?php echo site_url('recycle-booking-list')?>" id="frmsearch">          
             <div class="row">   
          ...
          <tbody>
               <?php
                ...
                <tr> 
                    ...
                    <td><?php echo date('d-m-Y h:i a', strtotime($ls['booking_date'] . '' . $ls['booking_time'])); ?>
                        <br /><br /><strong class="label label-warning"><?php echo $ls['franchise']?></strong>
                    </td> 
                    ...
                    <td>
                        <?php echo $ls['no_of_pieces']?> Nos.<br />
                        <?php echo $ls['chargable_weight']?> Kgs.<br />
                        Amt: <?php echo $ls['grand_total']?>  
                    </td>    
                    <td class="text-center">
                        <button value="<?php echo $ls['booking_id']?>" class="btn btn-primary btn-xs btn_restore"   name="btn_restore" title="Restore">Re-Store</a>
                    </td> 
                    <td class="text-center">
                        <button value="<?php echo $ls['booking_id']?>" class="btn btn-warning btn-xs del_record"   name="del_record" title="Delete">Delete</a>
                    </td>                                 
