               ...
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center">
                        <button data-toggle="modal" data-target="#edit_modal" value="<?php echo $ls['hd_category_id']?>" class="edit_record btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></button>
                    </td>                                  
                    <td class="text-center">
                        <button value="<?php echo $ls['hd_category_id']?>" class="del_record btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button>
                    </td>                                      
                </tr>
                <?php
                    }
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="hd_category_name" id="hd_category_name" value="">                                             
                                 </div> 
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <input type="hidden" name="hd_category_id" id="hd_category_id" />
                            </div>
                            <div class="modal-body"> 
                                 <div class="form-group">
                                    <label>Category Name</label>
